...
class Player:
    ...
    def place_ship(self, ship_name, size, start_pos: Tuple[int, int], 
                  orientation):
    ...
    def _get_valid_positions(self, ship_size, orientation) -> List[Tuple[int, int]]:
    ...
    def get_ship_positions(self, ship_name) -> List[Tuple[int, int]]:
