...
class Grid:
    ...
    def place_ship(self, ship: Ship, start_pos: Tuple[int, int], orientation):
    ...
    def _calculate_ship_positions(self, size, start_pos: Tuple[int, int], 
                                orientation) -> Optional[List[Tuple[int, int]]]:
    ...
    def _is_within_grid(self, pos: Tuple[int, int]):
    ...
    def get_cell_state(self, pos: Tuple[int, int]):
    ...
    def _is_valid_placement(self, positions: List[Tuple[int, int]]):
    ...
    def _is_valid_orientation(self, orientation: str):
